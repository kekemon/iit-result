<table width="300" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
    ...
    <td width="6">:</td>
    <td width="294"><input name="my_fullname" type="text" id="my_fullname" required></td>
    </tr>
    <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><input type="button" onclick="location.href='login.php'" name="Login" value="Login">&emsp;<input type="submit" name="Submit" value="Register"></td>
    </tr>
    </table>
    </td>
    </form>
